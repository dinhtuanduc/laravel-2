...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item active">
        <a class="nav-link" href="{{ url('/backend/admin/index') }}">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Quản trị người dùng</span></a>
    </li>
    <!-- Nav Item - Dashboard -->
    <li class="nav-item active">
    ...
    <div class="sidebar-card">
        <img class="sidebar-card-illustration mb-2" src="{{asset('be-assets/img/undraw_rocket.svg')}}" alt="">
